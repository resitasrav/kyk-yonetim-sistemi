...
CREATE TABLE IF NOT EXISTS izinler (
    ...
    izin_turu ENUM('yillik','mazeret','ucretsiz','hastalik') NOT NULL DEFAULT 'yillik',
...
CREATE TABLE IF NOT EXISTS maas_odemeleri (
    ...
    aciklama TEXT,
    olusturuldu TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_maas_personel FOREIGN KEY (personel_id) REFERENCES personel(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_turkish_ci;
...
CREATE TABLE IF NOT EXISTS etkinlik_katilim (
    ...
    durum ENUM('bekliyor','onaylandi','reddedildi') NOT NULL DEFAULT 'bekliyor',
    CONSTRAINT fk_katilim_etkinlik FOREIGN KEY (etkinlik_id) REFERENCES etkinlikler(id) ON DELETE CASCADE,
    CONSTRAINT fk_katilim_ogrenci FOREIGN KEY (ogrenci_id) REFERENCES ogrenciler(id) ON DELETE CASCADE,
...
('Fatma', 'Kaya', '98765432109', '2022002', 'Elektrik Elektronik', 2, '05329876543', 'fatma@example.com', '205');

INSERT INTO personel (ad, soyad, tc_no, sicil_no, gorevi, departman, telefon, email, ise_giris, maas) VALUES
('Mehmet', 'Demir', '11122233344', 'P001', 'Yurt Müdürü', 'Yönetim', '05331112233', 'mehmet@kyk.gov.tr', '2020-01-15', 35000.00),
('Ayşe', 'Çelik', '55566677788', 'P002', 'Memur', 'Öğrenci İşleri', '05335556677', 'ayse@kyk.gov.tr', '2021-03-01', 25000.00);

INSERT INTO izinler (personel_id, izin_turu, baslangic_tarihi, bitis_tarihi, gun_sayisi, aciklama, durum) VALUES
(1, 'yillik', '2026-06-10', '2026-06-15', 4, 'Yıllık iznimin bir kısmını kullanmak istiyorum.', 'bekliyor');

INSERT INTO maas_odemeleri (personel_id, odeme_ayi, net_maas, prim, kesinti, toplam, durum) VALUES
(2, '2026-05-01', 25000.00, 1500.00, 0.00, 26500.00, 'bekliyor');

-- Test kullanıcıları (yoneticiler tablosu)
-- admin@kyk.gov.tr / admin123
INSERT INTO yoneticiler (ad_soyad, email, sifre, rol, ilgili_id) VALUES
('KYK Yöneticisi', 'admin@kyk.gov.tr', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'yonetici', NULL),
('Mehmet Demir',   'mehmet@kyk.gov.tr', '$2y$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p360n.cFcDy4DlJmhBl22e', 'personel', 1),
('Ahmet Yılmaz',   'ahmet@example.com', '$2y$10$TKh8H1.PmFh97b4oDEY7xuCDFZHqHq6qFmyvvS4iqQBtfCk3p.TG6', 'ogrenci', 1);

-- Test etkinlikleri
INSERT INTO etkinlikler (baslik, aciklama, etkinlik_tarihi, kapasite, konum, durum) VALUES
('Bahar Şenliği',  'Yıllık bahar şenliğimize tüm öğrenciler davetlidir.', '2026-06-15', 200, 'Yurt Bahçesi', 'aktif'),
('Kariyer Günleri','Şirket temsilcileriyle networking etkinliği.',           '2026-06-20', 100, 'Konferans Salonu', 'aktif'),
('Spor Turnuvası', 'Futbol ve voleybol turnuvası.',                          '2026-07-01',  60, 'Spor Sahası', 'aktif');